...
# Make and disable TLS 1.1 for client and server SCHANNEL communications
...
# Make and disable TLS 1.0 for client and server SCHANNEL communications
...
new-itemproperty -path "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\SSL 3.0\Client" -name Enabled -value 1 -PropertyType "DWord"
